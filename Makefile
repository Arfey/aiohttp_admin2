...
# demo_main:
# 	WITHOUT_UPDATE_DB=1 DATABASE_URL=postgres://postgres:postgres@0.0.0.0:5432/postgres poetry run adev runserver demo/main/__init__.py

# demo_quick:
# 	@cd example_projects && docker-compose up -d
# 	DATABASE_URL=postgres://postgres:postgres@0.0.0.0:5432/postgres poetry run adev runserver example_projects/quick_start/app.py
